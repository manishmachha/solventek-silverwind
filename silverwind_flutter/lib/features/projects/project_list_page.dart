...
class _ProjectListPageState extends ConsumerState<ProjectListPage> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await svc.getProjects();
      if (mounted) {
        setState(() {
      ...
      body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Container(
            ...
            child: Icon(Icons.view_kanban, color: Colors.white, size: 28),
          ),
          const SizedBox(width: 16),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('Projects', style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: AppColors.textMain)),
            Text('${_items.length} projects', style: const TextStyle(fontSize: 14, color: AppColors.textMuted)),
          ])),
        ...
        Expanded(child: _loading
          ...
          : _items.isEmpty
            ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No projects found', style: TextStyle(fontSize: 16, color: AppColors.textMuted)),
              ]))
            : Container(
