...
class MyOrganizationPage extends ConsumerStatefulWidget {
  const MyOrganizationPage({super.key});
  @override
  ConsumerState<MyOrganizationPage> createState() => _MyOrganizationPageState();
}

class _MyOrganizationPageState extends ConsumerState<MyOrganizationPage> {
  List<dynamic> _items = [];
  bool _loading = true;
      ...
      body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('My Organization', style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: AppColors.textMain)),
            Text('${_items.length} details', style: const TextStyle(fontSize: 14, color: AppColors.textMuted)),
          ])),
        ...
        Expanded(child: _loading
          ...
          : _items.isEmpty
            ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No details found', style: TextStyle(fontSize: 16, color: AppColors.textMuted)),
              ]))
            : Container(
