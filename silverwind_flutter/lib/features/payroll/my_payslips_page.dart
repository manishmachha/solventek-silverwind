...
class MyPayslipsPage extends ConsumerStatefulWidget {
  const MyPayslipsPage({super.key});
  @override
  ConsumerState<MyPayslipsPage> createState() => _MyPayslipsPageState();
}

class _MyPayslipsPageState extends ConsumerState<MyPayslipsPage> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await svc.getMyPayslips();
      if (mounted) {
        setState(() {
      ...
      body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('My Payslips', style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: AppColors.textMain)),
            Text('${_items.length} payslips', style: const TextStyle(fontSize: 14, color: AppColors.textMuted)),
          ])),
        ...
        Expanded(child: _loading
          ...
          : _items.isEmpty
            ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No payslips found', style: TextStyle(fontSize: 16, color: AppColors.textMuted)),
              ]))
            : Container(
