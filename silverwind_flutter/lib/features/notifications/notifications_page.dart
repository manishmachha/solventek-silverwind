      ...
      body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('Notifications', style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: AppColors.textMain)),
            Text('${_items.length} notifications', style: const TextStyle(fontSize: 14, color: AppColors.textMuted)),
          ])),
        ...
        Expanded(child: _loading
          ...
          : _items.isEmpty
            ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No notifications found', style: TextStyle(fontSize: 16, color: AppColors.textMuted)),
              ]))
            : Container(
