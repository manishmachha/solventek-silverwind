...
class HolidayListPage extends ConsumerStatefulWidget {
  const HolidayListPage({super.key});
  @override
  ConsumerState<HolidayListPage> createState() => _HolidayListPageState();
}

class _HolidayListPageState extends ConsumerState<HolidayListPage> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await svc.getHolidays();
      if (mounted) {
        setState(() {
      ...
      body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('Holidays', style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: AppColors.textMain)),
            Text('${_items.length} holidays', style: const TextStyle(fontSize: 14, color: AppColors.textMuted)),
          ])),
        ...
        Expanded(child: _loading
          ...
          : _items.isEmpty
            ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No holidays found', style: TextStyle(fontSize: 16, color: AppColors.textMuted)),
              ]))
            : Container(
