...
class MyAssetsPage extends ConsumerStatefulWidget {
  const MyAssetsPage({super.key});
  @override
  ConsumerState<MyAssetsPage> createState() => _MyAssetsPageState();
}

class _MyAssetsPageState extends ConsumerState<MyAssetsPage> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await svc.getMyAssets();
      if (mounted) {
        setState(() {
      ...
      body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('My Assets', style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: AppColors.textMain)),
            Text('${_items.length} assets', style: const TextStyle(fontSize: 14, color: AppColors.textMuted)),
          ])),
        ...
        Expanded(child: _loading
          ...
          : _items.isEmpty
            ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No assets found', style: TextStyle(fontSize: 16, color: AppColors.textMuted)),
              ]))
            : Container(
