...
class _LeaveManagementPageState extends ConsumerState<LeaveManagementPage> {
        ...
        children: [
          ...
          Row(children: [
            Container(
              ...
              child: Icon(Icons.date_range, color: Colors.white, size: 28),
            ),
            const SizedBox(width: 16),
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Leave Management', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: AppColors.textMain)),
              Text('$_totalElements total requests', style: const TextStyle(fontSize: 14, color: AppColors.textMuted)),
            ])),
          ]),
          ...
          Expanded(child: _loading
            ...
            : filtered.isEmpty
              ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  const SizedBox(height: 16),
                  Text('No requests found', style: TextStyle(fontSize: 16, color: AppColors.textMuted, fontWeight: FontWeight.w500)),
                ]))
              : Container(
  ...
  Widget _buildListItem(Map<String, dynamic> item) {
    ...
    return ListTile(
      ...
      onTap: id.isNotEmpty ? () => context.go('/admin/leave-management/$id') : null,
    );
  }
