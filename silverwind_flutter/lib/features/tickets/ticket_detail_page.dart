...
class _TicketDetailPageState extends ConsumerState<TicketDetailPage> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      final result = await svc.getTicketById(widget.id);
  ...
  Widget build(BuildContext context) {
    final name = _data['firstName'] != null ? '${_data['firstName']} ${_data['lastName'] ?? ''}'
                : _data['title'] ?? _data['name'] ?? _data['subject'] ?? 'Ticket Details';
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                Container(
                  ...
                  child: Icon(Icons.confirmation_number, color: Colors.white, size: 24),
                ),
